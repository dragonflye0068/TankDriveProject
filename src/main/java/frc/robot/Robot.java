...
public class Robot extends LoggedRobot {
  ...
  private final CommandXboxController joystickyInstance = RobotContainer.m_driverController;
   ...
   */
  public Robot() {
    Logger.recordMetadata("ProjectName", "TankDriveProject"); // Set a metadata value
